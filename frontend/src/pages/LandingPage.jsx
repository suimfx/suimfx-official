        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-[120px] items-start">
          ...
          <div className="flex flex-col max-w-[480px]">
            ...
            <p className="text-[12px] leading-[1.6] text-black/70">
              Stock Tokens are derivative contracts between you and SetupFX24. They carry a high level of risk and are not appropriate for all investors.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-[60px] relative z-10">
        <div className="max-w-[480px]">
          <div className="mb-8 flex items-center gap-2">
            <span className="text-white text-[24px] font-medium">SetupFX24 Crypto</span>
          </div>
      ...
      <div className="max-w-[1440px] mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6 text-[12px] leading-[1.6]">
            ...
            <p>© 2025 SetupFX24. All rights reserved.</p>
          </div>
        </div>
