      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-dark-800 border-t border-gray-800 z-40">
        <div className="flex items-center justify-around h-16">
          <button
            ...
            className={`flex flex-col items-center justify-center flex-1 h-full ${activeTab === 'home' ? 'text-accent-green' : 'text-gray-500'
              }`}
          >
            <Home size={22} />
          ...
          <button
            ...
            className={`flex flex-col items-center justify-center flex-1 h-full ${activeTab === 'market' ? 'text-accent-green' : 'text-gray-500'
              }`}
          >
            <BarChart2 size={22} />
          ...
          <button
            ...
            className={`flex flex-col items-center justify-center flex-1 h-full ${activeTab === 'trade' ? 'text-accent-green' : 'text-gray-500'
              }`}
          >
            <TrendingUp size={22} />
          ...
          <button
            onClick={() => navigate('/account')}
            className={`flex flex-col items-center justify-center flex-1 h-full ${activeTab === 'chart' ? 'text-accent-green' : 'text-gray-500'
              }`}
          >
            <LineChart size={22} />
          ...
          <button
            ...
            className={`flex flex-col items-center justify-center flex-1 h-full ${activeTab === 'more' ? 'text-accent-green' : 'text-gray-500'
              }`}
          >
