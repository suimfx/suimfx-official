...
function checkEmployeePermissionForSidebar(permissions, sidebarKey) {
  ...
  const mapping = {
    ...
    'bookManagement': permissions.canViewBookManagement || permissions.canManageBookManagement,
...
export const PERMISSIONS = {
  ...
  EMPLOYEE: {
    ...
    VIEW_BOOK_MANAGEMENT: 'canViewBookManagement',
    MANAGE_BOOK_MANAGEMENT: 'canManageBookManagement',
